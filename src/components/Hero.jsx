      ...
      <div className="max-w-[1400px] mx-auto w-full pt-24 pb-8">
        ...
        <div className="grid lg:grid-cols-[55%_45%] items-center min-h-[calc(100vh-100px)] gap-10 w-full">
          ...
          <div className="w-full relative z-20 flex flex-col items-start mt-10 lg:mt-0">
            ...
            >
              <button className="inline-flex items-center justify-center gap-2 bg-[#811111] text-white px-8 py-3.5 rounded-full text-sm font-medium hover:bg-[#630b0b] transition-all whitespace-nowrap">
                View My Work
              ...
              <button className="inline-flex items-center justify-center gap-2 border border-[#811111] text-[#811111] px-8 py-3.5 rounded-full text-sm font-medium hover:bg-[#811111] hover:text-white transition-all whitespace-nowrap">
                Let's Talk
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17l9.2-9.2M17 16.8V7H7.2"/></svg>
              </button>
            </motion.div>
